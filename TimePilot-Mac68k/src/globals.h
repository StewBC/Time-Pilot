...
#define TP_COLOR_WHITE              1
#define TP_COLOR_RED                2
#define TP_COLOR_CYAN               3
#define TP_COLOR_MAGENTA            4
#define TP_COLOR_GREEN              5
#define TP_COLOR_BLUE               6
#define TP_COLOR_YELLOW             7
#define TP_COLOR_ORANGE             8
#define TP_COLOR_GRAY               9
#define TP_COLOR_DARK_RED           10
#define TP_COLOR_DARK_GREEN         11
#define TP_COLOR_DARK_YELLOW        12
#define TP_COLOR_PROP0              13
#define TP_COLOR_PROP1              14
#define TP_COLOR_SKY0               15
#define TP_COLOR_SKY1               16
#define TP_COLOR_SKY2               17
#define TP_COLOR_SKY3               18
#define TP_COLOR_SKY4               19
#define TP_NUM_COLORS               20

// Sprite & Sprite Draw constants
#define END_SHAPE_TOKEN             0L
#define LINE_START_TOKEN            1L
#define DRAW_PIXELS_TOKEN           2L
#define SKIP_PIXELS_TOKEN           3L
#define SPRITE_RESOURCE_TYPE        'Sprt'
...
#define NUM_PROGRESS_PLANES         (((SCOL-PLAYFIELDW)*SCOLW)/(2*SCOLW))
#define KEY_READ_RATE               2
#define WRAP_SIZE                   46

#define PLAYER_X                    13*SCOLW
#define PLAYER_Y                    14*SCOLW
...
#define ACTIVEFLAGS_ISDEAD          0b0000000000010000
...
// Mac
typedef struct {
    Rect spriteRect;                    // the rect that defines the bounds of the sprite
    Handle spriteData;                  // the sprite data itself
} tSpriteInfo;

extern PaletteHandle macPalette;
extern GWorldPtr offScreen;
extern PixMapHandle offScreenPixels;
extern Point spritePos;
extern Point displayPoint;
extern Rect gameRect;
extern Rect screenRect;
extern Rect spriteClipRect;             // the rectangle to clip to
extern RGBColor colors[TP_NUM_COLORS];
extern RgnHandle macOriginalGrayRgn;
extern short macMenuBarHeight;
extern tSpriteInfo *spritePtrs[];
extern uint16_t drawBackgroundColor;
extern uint16_t globalScale;
extern uint16_t keyMask;
extern uint32_t rowBytes;               // the row bytes of the pixmap
extern unsigned char *baseAddr;         // the base address of the pixmap
extern unsigned char rawKey;
...
// Print Buffer
extern char printBuffer[SCOL + 1];
...
// Audio
extern SndChannelPtr audioSourceChannels[AUDIO_CHANNELS];
extern Handle audioSourceHandles[];
extern int16_t audio_channel;
